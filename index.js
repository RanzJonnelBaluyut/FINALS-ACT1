const contacts = [
    ...
    {
        name: 'Ranz Jonnel Baluyut', // this should be your name
        imgUrl: 'https://group16.co.za/wp-content/uploads/2021/10/male-blank.jpg',
        phone: '+63 912 345 678',
        email: 'ranzjonnel.baluyut@gnc.edu.ph' // this should be your gnc email
    }
];
                ...
                <div className = "container"> 
                    ...
                    <div className = "box">
                        ...
                        <div className = "card">
                            ...
                            <img className = "profilePic" src={props.imgUrl}></img>     
